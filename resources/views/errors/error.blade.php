...
<head>
    ...
    <title>خطای سیستم - سروکست</title>
    <meta name="description" content="خطایی در سیستم رخ داده است. لطفاً بعداً دوباره تلاش کنید.">
...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <!-- Error Code -->
            <div class="mb-8">
                <h1 class="text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-gray-800 dark:from-gray-400 dark:to-gray-600">
                    @yield('error_code', 'خطا')
                </h1>
            </div>
            ...
            <div class="mb-8">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                    @yield('error_title', 'خطای سیستم')
                </h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
                    @yield('error_message', 'متأسفانه خطایی در سیستم رخ داده است. لطفاً بعداً دوباره تلاش کنید.')
                </p>
            </div>
            ...
            <div class="mb-12 flex justify-center">
                <div class="relative">
                    <div class="w-64 h-64 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-full flex items-center justify-center floating">
                        <svg class="w-32 h-32 text-gray-600 dark:text-gray-400 wiggle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Floating elements -->
                    <div class="absolute -top-4 -right-4 w-8 h-8 bg-gray-400 rounded-full pulse-slow"></div>
                    <div class="absolute -bottom-4 -left-4 w-6 h-6 bg-gray-500 rounded-full pulse-slow" style="animation-delay: 1s;"></div>
                    <div class="absolute top-1/2 -left-8 w-4 h-4 bg-gray-600 rounded-full pulse-slow" style="animation-delay: 2s;"></div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-200 dark:border-gray-700 mb-8">
                <div class="flex items-center justify-center mb-6">
                    <div class="w-12 h-12 bg-gray-500 rounded-xl flex items-center justify-center ml-4">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">اطلاعات خطا</h3>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="text-center p-4 rounded-xl bg-gray-50 dark:bg-gray-900">
                        <div class="text-2xl font-bold text-gray-600 dark:text-gray-400">خطا</div>
                        <div class="text-sm text-gray-700 dark:text-gray-300">سیستم</div>
                    </div>
                    <div class="text-center p-4 rounded-xl bg-blue-50 dark:bg-blue-900">
                        <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">در حال بررسی</div>
                        <div class="text-sm text-blue-700 dark:text-blue-300">تیم فنی</div>
                    </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <button onclick="location.reload()" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-gray-600 to-gray-800 hover:from-gray-700 hover:to-gray-900 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
