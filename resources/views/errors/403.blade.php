        ...
        <div class="text-center">
            ...
            <div class="mb-8">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
                    متأسفانه شما مجاز به دسترسی به این صفحه نیستید. لطفاً با مدیر سیستم تماس بگیرید.
                </p>
            </div>
            ...
            <div class="mb-12 flex justify-center">
                <div class="relative">
                    <div class="w-64 h-64 bg-gradient-to-br from-orange-100 to-red-100 dark:from-orange-900 dark:to-red-900 rounded-full flex items-center justify-center floating">
                    ...
                    <div class="absolute -bottom-4 -left-4 w-6 h-6 bg-red-400 rounded-full pulse-slow" style="animation-delay: 1s;"></div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-200 dark:border-gray-700 mb-8">
                <div class="flex items-center justify-center mb-6">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">اطلاعات دسترسی</h3>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="text-center p-4 rounded-xl bg-orange-50 dark:bg-orange-900">
                        <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">محدود</div>
                        <div class="text-sm text-orange-700 dark:text-orange-300">دسترسی</div>
                    </div>
                    <div class="text-center p-4 rounded-xl bg-blue-50 dark:bg-blue-900">
                        <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">نیاز به مجوز</div>
                        <div class="text-sm text-blue-700 dark:text-blue-300">مدیر سیستم</div>
                    </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <a href="{{ route('admin.auth.login') }}" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-200 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="text-right">
                        <h4 class="font-semibold text-gray-900 dark:text-white mb-3">برای کاربران</h4>
                        <ul class="space-y-2 text-gray-600 dark:text-gray-300">
                            ...
                            <li class="flex items-center">
                                ...
                                از حساب کاربری صحیح استفاده کنید
                            </li>
                            <li class="flex items-center">
                                <svg class="w-4 h-4 text-green-500 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                                مجوزهای دسترسی خود را بررسی کنید
                            </li>
                        </ul>
                    </div>
                    <div class="text-right">
                        <h4 class="font-semibold text-gray-900 dark:text-white mb-3">برای مدیران</h4>
                        <ul class="space-y-2 text-gray-600 dark:text-gray-300">
                            <li class="flex items-center">
