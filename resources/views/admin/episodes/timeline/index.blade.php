...
@section('title', 'مدیریت تایم‌لاین اپیزود')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">تایم‌لاین اپیزود</h1>
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="text-center">
                <div class="text-3xl font-bold text-green-600">{{ gmdate('i:s', $episode->duration) }}</div>
                <div class="text-gray-600">مدت زمان اپیزود</div>
            </div>
            <div class="text-center">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2 space-x-reverse">
                                        <a href="{{ route('admin.episodes.timeline.edit', [$episode, $timeline]) }}" 
                                        ...
                                        <form method="POST" action="{{ route('admin.episodes.timeline.destroy', [$episode, $timeline]) }}" 
