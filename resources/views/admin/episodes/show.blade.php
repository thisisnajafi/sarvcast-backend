        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if(!empty($imageUrls) && count($imageUrls) > 0)
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">تصاویر اپیزود</h3>
                                ...
                                <div class="flex items-center space-x-3 space-x-reverse">
                                    <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center">
                                        <img src="{{ $voiceActor->person?->image_url ?: '/images/default-avatar.png' }}"
                                             alt="{{ $voiceActor->person?->name ?? 'نامشخص' }}"
                                             class="w-10 h-10 rounded-full object-cover"
                                             onerror="this.src='/images/default-avatar.png'">
                                    </div>
                                    <div>
                                        <div class="text-sm font-medium text-gray-900">{{ $voiceActor->person?->name ?? 'نامشخص' }}</div>
                                        <div class="text-xs text-gray-500">{{ $voiceActor->role ?? 'نامشخص' }}</div>
                                    </div>
                                </div>
