...
@section('title', 'ایجاد پلن اشتراک جدید')
@section('page-title', 'ایجاد پلن اشتراک جدید')

@section('content')
<div class="space-y-6">
    <!-- Page Header -->
    @include('admin.components.page-header', [
        'title' => 'ایجاد پلن اشتراک جدید',
        'subtitle' => 'ایجاد پلن اشتراک جدید با تنظیمات قیمت برای هر پلتفرم',
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug') }}"
                           ...
                           placeholder="مثال: 1month (خودکار از نام ایجاد می‌شود)">
                    @error('slug')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">اگر خالی بماند، از نام پلن ایجاد می‌شود</p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              placeholder="توضیحات پلن اشتراک...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select name="currency" id="currency"
                        ...
                        <option value="IRT" {{ old('currency', 'IRT') === 'IRT' ? 'selected' : '' }}>تومان (IRT)</option>
                        <option value="IRR" {{ old('currency') === 'IRR' ? 'selected' : '' }}>ریال (IRR)</option>
                    </select>
                    @error('currency')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="discount_percentage" id="discount_percentage" value="{{ old('discount_percentage', 0) }}" min="0" max="100"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        @error('price')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">شناسه محصول: از slug استفاده می‌شود</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="myket_price" id="myket_price" value="{{ old('myket_price') }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="text" name="myket_product_id" id="myket_product_id" value="{{ old('myket_product_id') }}"
            ...
            <div class="mb-6 p-4 bg-orange-50 rounded-lg border border-orange-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="cafebazaar_price" id="cafebazaar_price" value="{{ old('cafebazaar_price') }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="text" name="cafebazaar_product_id" id="cafebazaar_product_id" value="{{ old('cafebazaar_product_id') }}"
