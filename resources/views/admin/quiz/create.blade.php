...
@section('title', 'افزودن سؤال کویز جدید')
@section('page-title', 'افزودن سؤال کویز جدید')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-sm rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-lg font-medium text-gray-900">افزودن سؤال کویز جدید</h1>
            <p class="mt-1 text-sm text-gray-600">اطلاعات سؤال کویز جدید را وارد کنید.</p>
        </div>

        <form method="POST" action="{{ route('admin.quiz.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="question_text" id="question_text" rows="4" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent @error('question_text') border-red-500 @enderror" placeholder="متن سؤال را وارد کنید...">{{ old('question_text') }}</textarea>
                @error('question_text')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="question_type" id="question_type" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent @error('question_type') border-red-500 @enderror">
                        ...
                        <option value="multiple_choice" {{ old('question_type') == 'multiple_choice' ? 'selected' : '' }}>چندگزینه‌ای</option>
                        <option value="true_false" {{ old('question_type') == 'true_false' ? 'selected' : '' }}>درست/غلط</option>
                        <option value="fill_blank" {{ old('question_type') == 'fill_blank' ? 'selected' : '' }}>جای خالی</option>
                        <option value="matching" {{ old('question_type') == 'matching' ? 'selected' : '' }}>تطبیق</option>
                        <option value="essay" {{ old('question_type') == 'essay' ? 'selected' : '' }}>انشایی</option>
                    </select>
                    @error('question_type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="difficulty_level" id="difficulty_level" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent @error('difficulty_level') border-red-500 @enderror">
                        ...
                        <option value="easy" {{ old('difficulty_level') == 'easy' ? 'selected' : '' }}>آسان</option>
                        <option value="medium" {{ old('difficulty_level') == 'medium' ? 'selected' : '' }}>متوسط</option>
                        <option value="hard" {{ old('difficulty_level') == 'hard' ? 'selected' : '' }}>سخت</option>
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="points" id="points" value="{{ old('points', 10) }}" min="1" max="100" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent @error('points') border-red-500 @enderror" placeholder="10">
                    @error('points')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="time_limit" id="time_limit" value="{{ old('time_limit') }}" min="10" max="3600" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent @error('time_limit') border-red-500 @enderror" placeholder="60">
                    @error('time_limit')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div id="options-container">
                    <div class="space-y-3">
                        <div class="flex items-center space-x-3 space-x-reverse">
                            <input type="text" name="options[]" placeholder="گزینه 1" class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                            <input type="checkbox" name="correct_options[]" value="0" class="rounded">
                            <span class="text-sm text-gray-600">پاسخ صحیح</span>
                        </div>
                        <div class="flex items-center space-x-3 space-x-reverse">
                            <input type="text" name="options[]" placeholder="گزینه 2" class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                            <input type="checkbox" name="correct_options[]" value="1" class="rounded">
                            <span class="text-sm text-gray-600">پاسخ صحیح</span>
                        </div>
                        <div class="flex items-center space-x-3 space-x-reverse">
                            <input type="text" name="options[]" placeholder="گزینه 3" class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                            <input type="checkbox" name="correct_options[]" value="2" class="rounded">
                            <span class="text-sm text-gray-600">پاسخ صحیح</span>
                        </div>
                        <div class="flex items-center space-x-3 space-x-reverse">
                            <input type="text" name="options[]" placeholder="گزینه 4" class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                            <input type="checkbox" name="correct_options[]" value="3" class="rounded">
                            <span class="text-sm text-gray-600">پاسخ صحیح</span>
                        </div>
                    </div>
            ...
            <div id="correct-answer-section">
                ...
                <input type="text" name="correct_answer" id="correct_answer" value="{{ old('correct_answer') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent @error('correct_answer') border-red-500 @enderror" placeholder="پاسخ صحیح را وارد کنید...">
            ...
            <div>
                ...
                <textarea name="explanation" id="explanation" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent @error('explanation') border-red-500 @enderror" placeholder="توضیح پاسخ صحیح...">{{ old('explanation') }}</textarea>
                @error('explanation')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="tags_input" id="tags_input" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent" placeholder="برچسب‌ها را با کاما جدا کنید...">
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded border-gray-300 text-red-600 focus:ring-red-500">
