...
<div class="space-y-6">
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-200 min-w-0">
            <div class="flex items-center space-x-3 space-x-reverse">
                ...
                <div class="ml-3 sm:ml-4 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900 truncate">
                        {{ number_format($stats['total_commission_paid']) }}
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-200 min-w-0">
            <div class="flex items-center space-x-3 space-x-reverse">
                ...
                <div class="ml-3 sm:ml-4 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900 truncate">
                        {{ number_format($stats['verified_partners']) }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 min-w-0">
            ...
            <div id="partnerTypesChart" class="h-56 sm:h-64 md:h-72"></div>
        </div>

        <!-- Commission Trends -->
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 min-w-0">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">روند کمیسیون‌ها</h3>
            <div id="commissionTrendsChart" class="h-56 sm:h-64 md:h-72"></div>
        </div>
    </div>
