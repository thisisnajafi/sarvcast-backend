...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">ویرایش دسته‌بندی: {{ $category->name }}</h1>
        <div class="flex space-x-4 space-x-reverse">
            <a href="{{ route('admin.categories.show', $category) }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-200">
                مشاهده
            </a>
        ...
        <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
            ...
            @if($category->image_url)
                <div class="mb-6">
                    ...
                    <img src="{{ $category->image_url }}" alt="Category Image" class="w-32 h-32 object-cover rounded-lg border">
                </div>
            @endif
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <input type="text" name="color_hex" id="color_hex" value="{{ old('color', $category->color ?? '#3B82F6') }}" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="status" id="status" 
                        ...
                        <option value="inactive" {{ old('status', $category->status) == 'inactive' ? 'selected' : '' }}>غیرفعال</option>
                    </select>
                    @error('status')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3" 
                                  ...
                                  placeholder="توضیحات متا برای SEO">{{ old('meta_description', $category->meta_description) }}</textarea>
