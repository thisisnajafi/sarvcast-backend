...
<div class="container mx-auto px-4 py-8">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">داشبورد سکه‌ها</h1>
        <p class="text-gray-600">مدیریت سکه‌ها، تراکنش‌ها و گزینه‌های تبدیل</p>
    </div>
    ...
    <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-lg p-6 mb-8 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold mb-2">موجودی سکه‌ها</h2>
                <div class="text-4xl font-bold" id="coin-balance">0</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-gray-900">کسب سکه</h3>
                    <p class="text-gray-600">از طریق ارجاع و آزمون</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-gray-900">تراکنش‌ها</h3>
                    <p class="text-gray-600">تاریخچه کامل</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-gray-600">گزینه‌های تبدیل</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md mb-8">
        ...
        <div class="p-6">
            ...
            <div class="text-center mt-6">
                <button id="load-more-transactions" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                    مشاهده بیشتر
                </button>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-900">گزینه‌های تبدیل سکه</h2>
        </div>
        <div class="p-6">
            <div id="redemption-options" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
