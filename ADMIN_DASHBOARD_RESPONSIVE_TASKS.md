...
- [ ] **Convert fixed sidebar to responsive off‑canvas on small screens**
...
- [ ] **Unify and simplify sidebar toggle logic for mobile**
...
- [ ] **Ensure header and top bar elements wrap/stack correctly on small screens**
...
- [ ] **Audit all `grid-cols-*` vs fixed widths to avoid horizontal scroll**
...
- [ ] **Make the hero / welcome section fully responsive**
...
- [ ] **Normalize statistics card grid across breakpoints**
...
- [ ] **Ensure secondary “Plan Sales Overview” row behaves on small screens**
...
- [ ] **Improve responsiveness of “Quick Actions” icon grid**
...
- [ ] **Tighten content grids and tables to avoid nested scroll on small screens**
...
- [ ] **Standardize statistics card spacing and wrapping**
...
- [ ] **Make chart containers fully height‑responsive**
...
- [ ] **Optimize “Performance Metrics” grid on mobile**
...
- [ ] **Tables and lists overflow control**
...
- [ ] **Ensure revenue statistics cards scale well on small widths**
...
- [ ] **Responsive behavior of revenue and payment method charts**
...
- [ ] **Monthly comparison and conversion metrics grids**
...
- [ ] **Top customers/transactions lists truncation**
...
- [ ] **Align statistics cards with global responsive pattern**
...
- [ ] **Check charts row responsiveness**
...
- [ ] **Monthly performance table horizontal scrolling**
