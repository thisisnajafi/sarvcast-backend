# راهنمای مدیریت فایل‌های صوتی - پنل مدیریت مانجی

## مقدمه

این راهنما برای مدیران مانجی تهیه شده است تا بتوانند فایل‌های صوتی قسمت‌ها را به طور کامل مدیریت کنند. تمامی عملیات مربوط به فایل‌های صوتی فقط از طریق پنل مدیریت قابل انجام است.
...
**نکته مهم**: این راهنما برای مدیران مانجی تهیه شده است. برای سوالات فنی، با تیم پشتیبانی تماس بگیرید.
