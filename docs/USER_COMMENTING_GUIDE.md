...
سیستم نظرات در مانجی به شما امکان می‌دهد تا نظرات خود را درباره داستان‌های مختلف به اشتراک بگذارید. این سیستم برای ایجاد تعامل بیشتر بین کاربران و بهبود تجربه گوش دادن به داستان‌ها طراحی شده است.
...
**نکته مهم**: این راهنما برای کاربران عادی مانجی تهیه شده است. برای استفاده از API، به مستندات فنی مراجعه کنید.
