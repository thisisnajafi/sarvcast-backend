...
API پنل مدیریت Manji یک RESTful API است که امکان مدیریت کامل سیستم را فراهم می‌کند. این API از استانداردهای HTTP استفاده می‌کند و پاسخ‌ها را در قالب JSON ارائه می‌دهد.
