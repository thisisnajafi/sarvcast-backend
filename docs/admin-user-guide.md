# راهنمای کاربری پنل مدیریت Manji
...
پنل مدیریت Manji یک سیستم جامع برای مدیریت تمامی جنبه‌های پلتفرم پادکست است. این پنل شامل ابزارهای پیشرفته برای مدیریت کاربران، محتوا، پرداخت‌ها، و تحلیل‌های آماری می‌باشد.
